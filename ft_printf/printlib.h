...
int		print_di(char a[15], int m[13], int k, int n);
...
int		print_ldi(char a[15], int m[13], int k, long int n);
...
int		print_lldi(char a[15], int m[13], int k, long long int n);
...
int		print_hdi(char a[15], int m[13], int k, short int n);
...
int		print_x(char a[15], int m[13], int k, unsigned int n);
...
int		print_lx(char a[15], int m[13], int k, unsigned long int n);
...
int		print_llx(char a[15], int m[13], int k, unsigned long long int n);
...
int		print_hx(char a[15], int m[13], int k, unsigned short int n);
...
int		print_hhdi(char a[15], int m[13], int k, signed char n);
...
int		print_lf(char t[100], int m[13], char a[21], long double n);
int		type_lf(va_list *vl, int m[13]);
int		lftoc(char a[21], long long int n, int m[13]);
void	signlf(long double n, int f1, int f2);
...
int		print_bon(char a[50], int m[13], int k, unsigned int n);
...
int		print_llo(char a[50], int m[13], int k, unsigned long long int n);
int		print_lo(char a[50], int m[13], int k, unsigned long int n);
void	nil(char a[21]);
